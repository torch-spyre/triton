...
// CHECK:           %[[VAL_5:.*]] = ktdp.construct_memory_view %[[VAL_4]], sizes: [2, 64, 64], strides: [4096, 64, 1] {coordinate_set = #[[$ATTR_1]], memory_space = #ktdp.memory_space<global>, spyre.provenance = "kept"} : memref<2x64x64xf32>
...
// CHECK:           %[[VAL_10:.*]] = ktdp.construct_access_tile %[[VAL_5]]{{\[}}%[[VAL_7]], %[[VAL_3]], %[[VAL_9]]] {access_tile_order = #[[$ATTR_0]], access_tile_set = #[[$ATTR_1]], spyre.tile_note = 7 : i64} : memref<2x64x64xf32> -> !ktdp.access_tile<2x64x64xindex>
...
// CHECK:           %[[VAL_13:.*]] = ktdp.construct_memory_view %[[VAL_12]], sizes: [2, 64, 64], strides: [4096, 64, 1] {coordinate_set = #[[$ATTR_1]], memory_space = #ktdp.memory_space<global>} : memref<2x64x64xf32>
...
// CHECK:           %[[VAL_18:.*]] = ktdp.construct_access_tile %[[VAL_13]]{{\[}}%[[VAL_15]], %[[VAL_3]], %[[VAL_17]]] {access_tile_order = #[[$ATTR_0]], access_tile_set = #[[$ATTR_1]]} : memref<2x64x64xf32> -> !ktdp.access_tile<2x64x64xindex>
...
// CHECK:           %[[VAL_21:.*]] = ktdp.construct_memory_view %[[VAL_20]], sizes: [2, 64, 64], strides: [4096, 64, 1] {coordinate_set = #[[$ATTR_1]], memory_space = #ktdp.memory_space<global>} : memref<2x64x64xf32>
...
// CHECK:           %[[VAL_26:.*]] = ktdp.construct_access_tile %[[VAL_21]]{{\[}}%[[VAL_23]], %[[VAL_3]], %[[VAL_25]]] {access_tile_order = #[[$ATTR_0]], access_tile_set = #[[$ATTR_1]]} : memref<2x64x64xf32> -> !ktdp.access_tile<2x64x64xindex>
// CHECK:           %[[VAL_27:.*]] = tensor.empty() : tensor<2x64x64xf32>
// CHECK:           %[[VAL_28:.*]] = linalg.generic {indexing_maps = [#[[$ATTR_0]], #[[$ATTR_0]], #[[$ATTR_0]]], iterator_types = ["parallel", "parallel", "parallel"]} ins(%[[VAL_11]], %[[VAL_19]] : tensor<2x64x64xf32>, tensor<2x64x64xf32>) outs(%[[VAL_27]] : tensor<2x64x64xf32>) {
