...
// CHECK:           %[[VAL_6:.*]] = ktdp.construct_memory_view %[[VAL_5]], sizes: [2, 64, 64], strides: [4096, 64, 1] {coordinate_set = #[[$ATTR_1]], memory_space = #ktdp.memory_space<global>} : memref<2x64x64xf32>
// CHECK:           %[[VAL_7:.*]] = builtin.unrealized_conversion_cast %[[VAL_1]] : !tt.ptr<f32> to index
// CHECK:           %[[VAL_8:.*]] = ktdp.construct_memory_view %[[VAL_7]], sizes: [2, 64, 64], strides: [4096, 64, 1] {coordinate_set = #[[$ATTR_1]], memory_space = #ktdp.memory_space<global>} : memref<2x64x64xf32>
...
// CHECK:             %[[VAL_14:.*]] = ktdp.construct_access_tile %[[VAL_6]]{{\[}}%[[VAL_11]], %[[VAL_2]], %[[VAL_13]]] {access_tile_order = #[[$ATTR_0]], access_tile_set = #[[$ATTR_1]]} : memref<2x64x64xf32> -> !ktdp.access_tile<2x64x64xindex>
...
// CHECK:             %[[VAL_20:.*]] = ktdp.construct_access_tile %[[VAL_8]]{{\[}}%[[VAL_17]], %[[VAL_2]], %[[VAL_19]]] {access_tile_order = #[[$ATTR_0]], access_tile_set = #[[$ATTR_1]]} : memref<2x64x64xf32> -> !ktdp.access_tile<2x64x64xindex>
// CHECK:             %[[VAL_21:.*]] = tensor.empty() : tensor<2x64x64xf32>
// CHECK:             %[[VAL_22:.*]] = linalg.generic {indexing_maps = [#[[$ATTR_0]], #[[$ATTR_0]]], iterator_types = ["parallel", "parallel", "parallel"]} ins(%[[VAL_15]] : tensor<2x64x64xf32>) outs(%[[VAL_21]] : tensor<2x64x64xf32>) {
