...
#
# No stick-layout variant here. The rationale this note used to carry was stated
# against the named layout pass, which no longer exists; it has not been
# re-derived against RewriteDescriptorLayoutGeneric.
# ---------------------------------------------------------------------------
