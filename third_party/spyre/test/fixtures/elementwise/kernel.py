...
``ASTSource``. Taking the runtime scalars from the variant's signature instead
broke that chain: a param can now drive a fixture without being an argument of
anything.
"""
