...
// CHECK:           %[[VAL_9:.*]] = arith.index_cast %[[VAL_3]] : i32 to index
// CHECK:           %[[VAL_10:.*]] = ktdp.construct_indirect_access_tile intermediate_variables(%[[VAL_11:.*]], %[[VAL_12:.*]]) %[[VAL_8]][ind(%[[VAL_5]]{{\[}}%[[VAL_6]] + %[[VAL_11]]]), (%[[VAL_9]] + %[[VAL_12]])] {variables_space_order = #[[$ATTR_4]], variables_space_set = #[[$ATTR_7]]} : memref<512x128xf32>, memref<32xi32> -> !ktdp.access_tile<32x128xindex>
...
// CHECK:           %[[VAL_17:.*]] = arith.index_cast %[[VAL_3]] : i32 to index
// CHECK:           %[[VAL_18:.*]] = ktdp.construct_access_tile %[[VAL_15]]{{\[}}%[[VAL_16]], %[[VAL_17]]] {access_tile_order = #[[$ATTR_4]], access_tile_set = #[[$ATTR_7]]} : memref<32x128xf32> -> !ktdp.access_tile<32x128xindex>
