...
// CHECK:           %[[VAL_16:.*]] = linalg.generic {indexing_maps = [#[[$ATTR_7]], #[[$ATTR_8]]], iterator_types = ["reduction", "parallel", "reduction", "parallel"]} ins(%[[VAL_10]] : tensor<2x256x64xf32>) outs(%[[VAL_15]] : tensor<256x64xf32>) {
