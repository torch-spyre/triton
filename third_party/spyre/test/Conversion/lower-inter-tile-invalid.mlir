...
// A layout annotation plus an inter-tile reduction is not yet supported:
// RewriteDescriptorLayout, which now runs after this pass, has no propagation
// pattern for the produce/reduce pair and cannot reach through a tile_future.
// Refused here rather than downstream as a type mismatch.
